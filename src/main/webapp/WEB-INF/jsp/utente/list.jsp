	  ...
	  <div class="container">
			...
			<div class='card'>
			    ...
			    <div class='card-body border border-success'>
			    	...
			    	<a href="${pageContext.request.contextPath}/utente/search" class='btn btn-outline-danger' >
			                	...
			                	<c:forEach items="${utente_list_attribute }" var="utenteItem">
									<tr>
										...
										<td>
											...
											<a class="btn btn-sm btn-secondary" href="${pageContext.request.contextPath}/utente/show/${utenteItem.id }">Visualizza</a>
